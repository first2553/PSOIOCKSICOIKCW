...
local serv = win:Server("ZeroX Hub", "")
local Tab1 = serv:Channel("Main1")
...
local Dropdownz = Tab1:Dropdown("Select Dropdown", {
      "Dropdown1",
      "Dropdown2",
      "Dropdown3",
      "Dropdown4",
...
Tab1:Button("Refresh Dropdown",function()
    Dropdownz.Clear()
for i,v in pairs(game:GetService("Dropdownz"):GetChildren()) do
       Dropdownz.insert(Dropdownz)
end
end)
